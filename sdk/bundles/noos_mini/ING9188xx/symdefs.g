...
att_server_can_send_packet_now = 0x00005fd9;
att_server_deferred_read_response = 0x00005fdd;
att_server_get_mtu = 0x00005ff5;
att_server_indicate = 0x00006061;
att_server_init = 0x000060e5;
att_server_notify = 0x00006121;
att_server_register_packet_handler = 0x00006239;
att_server_request_can_send_now_event = 0x0000626b;
att_set_db = 0x00006287;
att_set_read_callback = 0x00006299;
att_set_write_callback = 0x000062a5;
bd_addr_cmp = 0x0000642f;
bd_addr_copy = 0x00006435;
...
gatt_client_prepare_write = 0x000086a3;
gatt_client_read_characteristic_descriptor_using_descriptor_handle = 0x000086df;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle = 0x00008709;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x0000870f;
gatt_client_read_long_value_of_characteristic_using_value_handle = 0x0000873d;
gatt_client_read_long_value_of_characteristic_using_value_handle_with_offset = 0x00008743;
gatt_client_read_multiple_characteristic_values = 0x00008771;
gatt_client_read_value_of_characteristic_using_value_handle = 0x000087a1;
gatt_client_read_value_of_characteristics_by_uuid128 = 0x000087cf;
gatt_client_read_value_of_characteristics_by_uuid16 = 0x0000881b;
gatt_client_register_handler = 0x00008865;
gatt_client_reliable_write_long_value_of_characteristic = 0x00008871;
...
hci_add_event_handler = 0x0000a3b1;
hci_power_control = 0x0000ab31;
hci_register_acl_packet_handler = 0x0000ace5;
kv_commit = 0x0000b445;
kv_get = 0x0000b4a1;
kv_init = 0x0000b4ad;
kv_init_backend = 0x0000b529;
kv_put = 0x0000b53d;
kv_remove = 0x0000b549;
kv_remove_all = 0x0000b581;
kv_value_modified = 0x0000b5b1;
kv_value_modified_of_key = 0x0000b5cd;
kv_visit = 0x0000b5d9;
l2cap_add_event_handler = 0x0000b669;
l2cap_can_send_packet_now = 0x0000b679;
l2cap_create_le_credit_based_connection_request = 0x0000b835;
l2cap_credit_based_send = 0x0000b979;
l2cap_credit_based_send_continue = 0x0000b9a5;
l2cap_disconnect = 0x0000ba21;
l2cap_get_le_credit_based_connection_credits = 0x0000bc69;
