...
char_for_nibble = 0x020066ed;
gap_add_dev_to_periodic_list = 0x02007079;
gap_add_whitelist = 0x02007089;
gap_aes_encrypt = 0x02007095;
gap_clear_white_lists = 0x020070cd;
gap_clr_adv_set = 0x020070d9;
gap_clr_periodic_adv_list = 0x020070e5;
gap_create_connection_cancel = 0x020070f1;
gap_default_periodic_adv_sync_transfer_param = 0x020070fd;
gap_disconnect = 0x02007115;
gap_disconnect2 = 0x0200711d;
gap_disconnect_all = 0x02007149;
gap_ext_create_connection = 0x02007189;
gap_get_connection_parameter_range = 0x02007261;
gap_le_read_channel_map = 0x02007299;
gap_periodic_adv_create_sync = 0x020072f9;
gap_periodic_adv_create_sync_cancel = 0x0200731d;
gap_periodic_adv_set_info_transfer = 0x02007329;
gap_periodic_adv_sync_transfer = 0x02007339;
gap_periodic_adv_sync_transfer_param = 0x02007349;
gap_periodic_adv_term_sync = 0x02007365;
gap_read_antenna_info = 0x020073ed;
gap_read_periodic_adv_list_size = 0x020073f9;
gap_read_phy = 0x02007405;
gap_read_remote_used_features = 0x02007411;
gap_read_remote_version = 0x0200741d;
gap_read_rssi = 0x02007429;
gap_read_white_lists_size = 0x02007435;
gap_remove_whitelist = 0x02007441;
gap_rmv_adv_set = 0x020074bd;
gap_rmv_dev_from_periodic_list = 0x020074c9;
gap_rx_test_v2 = 0x020074d9;
gap_rx_test_v3 = 0x020074e9;
gap_set_adv_set_random_addr = 0x02007535;
gap_set_callback_for_next_hci = 0x02007559;
gap_set_connection_cte_request_enable = 0x02007579;
gap_set_connection_cte_response_enable = 0x02007595;
gap_set_connection_cte_rx_param = 0x020075a5;
gap_set_connection_cte_tx_param = 0x020075f9;
gap_set_connection_parameter_range = 0x02007645;
gap_set_connectionless_cte_tx_enable = 0x0200765d;
gap_set_connectionless_cte_tx_param = 0x0200766d;
gap_set_connectionless_iq_sampling_enable = 0x020076c9;
gap_set_data_length = 0x02007725;
gap_set_def_phy = 0x0200773d;
gap_set_ext_adv_data = 0x0200774d;
gap_set_ext_adv_enable = 0x02007765;
gap_set_ext_adv_para = 0x020077d5;
gap_set_ext_scan_enable = 0x02007895;
gap_set_ext_scan_para = 0x020078ad;
gap_set_ext_scan_response_data = 0x0200794d;
gap_set_host_channel_classification = 0x02007965;
gap_set_periodic_adv_data = 0x02007975;
gap_set_periodic_adv_enable = 0x020079e5;
gap_set_periodic_adv_para = 0x020079f5;
gap_set_periodic_adv_rx_enable = 0x02007a0d;
gap_set_phy = 0x02007a1d;
gap_set_random_device_address = 0x02007a39;
gap_start_ccm = 0x02007a55;
gap_test_end = 0x02007a9d;
gap_tx_test_v2 = 0x02007aa9;
gap_tx_test_v4 = 0x02007ac1;
gap_update_connection_parameters = 0x02007ae5;
gap_vendor_tx_continuous_wave = 0x02007b29;
gatt_client_cancel_write = 0x02008051;
gatt_client_discover_characteristic_descriptors = 0x02008077;
gatt_client_discover_characteristics_for_handle_range_by_uuid128 = 0x020080b7;
gatt_client_discover_characteristics_for_handle_range_by_uuid16 = 0x02008107;
gatt_client_discover_characteristics_for_service = 0x02008157;
gatt_client_discover_primary_services = 0x0200818d;
gatt_client_discover_primary_services_by_uuid128 = 0x020081bf;
gatt_client_discover_primary_services_by_uuid16 = 0x02008203;
gatt_client_execute_write = 0x02008241;
gatt_client_find_included_services_for_service = 0x02008267;
gatt_client_get_mtu = 0x02008295;
gatt_client_is_ready = 0x02008361;
gatt_client_listen_for_characteristic_value_updates = 0x02008377;
gatt_client_prepare_write = 0x02008399;
gatt_client_read_characteristic_descriptor_using_descriptor_handle = 0x020083d5;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle = 0x020083ff;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x02008405;
gatt_client_read_long_value_of_characteristic_using_value_handle = 0x02008433;
gatt_client_read_long_value_of_characteristic_using_value_handle_with_offset = 0x02008439;
gatt_client_read_multiple_characteristic_values = 0x02008467;
gatt_client_read_value_of_characteristic_using_value_handle = 0x02008497;
gatt_client_read_value_of_characteristics_by_uuid128 = 0x020084c5;
gatt_client_read_value_of_characteristics_by_uuid16 = 0x02008511;
gatt_client_register_handler = 0x0200855d;
gatt_client_reliable_write_long_value_of_characteristic = 0x02008569;
gatt_client_signed_write_without_response = 0x0200899d;
gatt_client_write_characteristic_descriptor_using_descriptor_handle = 0x02008a61;
gatt_client_write_client_characteristic_configuration = 0x02008a9b;
gatt_client_write_long_characteristic_descriptor_using_descriptor_handle = 0x02008aed;
gatt_client_write_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x02008afd;
gatt_client_write_long_value_of_characteristic = 0x02008b39;
gatt_client_write_long_value_of_characteristic_with_offset = 0x02008b49;
gatt_client_write_value_of_characteristic = 0x02008b85;
gatt_client_write_value_of_characteristic_without_response = 0x02008bbb;
hci_add_event_handler = 0x0200a1dd;
hci_power_control = 0x0200a981;
hci_register_acl_packet_handler = 0x0200ab35;
kv_commit = 0x0200b259;
kv_get = 0x0200b2b5;
kv_init = 0x0200b2c1;
kv_init_backend = 0x0200b341;
kv_put = 0x0200b355;
kv_remove = 0x0200b361;
kv_remove_all = 0x0200b399;
kv_value_modified = 0x0200b3c9;
kv_value_modified_of_key = 0x0200b3e5;
kv_visit = 0x0200b3f1;
l2cap_add_event_handler = 0x0200b481;
l2cap_can_send_packet_now = 0x0200b491;
l2cap_create_le_credit_based_connection_request = 0x0200b655;
l2cap_credit_based_send = 0x0200b79d;
l2cap_credit_based_send_continue = 0x0200b7c9;
l2cap_disconnect = 0x0200b845;
l2cap_get_le_credit_based_connection_credits = 0x0200ba29;
