...
btstack_memory_pool_create = 0x0200640d;
btstack_memory_pool_free = 0x02006435;
btstack_memory_pool_get = 0x02006495;
btstack_push_user_msg = 0x020064fd;
btstack_push_user_runnable = 0x02006509;
btstack_reset = 0x02006515;
char_for_nibble = 0x0200680f;
...
hci_add_event_handler = 0x0200a2f1;
hci_power_control = 0x0200aa95;
hci_register_acl_packet_handler = 0x0200ac49;
kv_commit = 0x0200b345;
kv_get = 0x0200b3a1;
kv_init = 0x0200b3ad;
kv_init_backend = 0x0200b42d;
kv_put = 0x0200b441;
kv_remove = 0x0200b44d;
kv_remove_all = 0x0200b485;
kv_value_modified = 0x0200b4b5;
kv_value_modified_of_key = 0x0200b4d1;
kv_visit = 0x0200b4dd;
l2cap_add_event_handler = 0x0200b56d;
l2cap_can_send_packet_now = 0x0200b57d;
l2cap_create_le_credit_based_connection_request = 0x0200b741;
l2cap_credit_based_send = 0x0200b889;
l2cap_credit_based_send_continue = 0x0200b8b5;
l2cap_disconnect = 0x0200b931;
l2cap_get_le_credit_based_connection_credits = 0x0200bb15;
