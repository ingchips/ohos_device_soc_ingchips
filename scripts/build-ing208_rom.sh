#!/usr/bin/env bash
# ============================================================
# 编译 ing208_rom(rom 版本) + 自动更新 compile_commands.json（容器内运行）
# 用法（容器内）：
#   bash /home/ohos/openharmony/build-ing208_rom.sh [hb build 参数...]
# 宿主一键（wrapper）：bash /home/ming/openharmony/build-ing208_rom.sh
# ============================================================
set -euo pipefail
